...
is not in the table, open or not: it appears **while the pointer is on the entity**.
...
because the button in the corner will say **Clean layout** rather than **Mermaid layout**. A
