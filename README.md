...
above — and the diagram is laid out again around it. Hold **Ctrl** (**⌥ Option** on a Mac) with
the pointer on an entity's header to read what it is for, or on a column to read what it holds. See [docs/2. DIAGRAMS.md](./docs/2.%20DIAGRAMS.md#entity-sheet).
